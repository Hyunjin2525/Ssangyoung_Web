...
public class BoardDeleteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<html>");//print or printl 둘다 화면 출력에 영향 없다
		out.println("<head>");
		...
		out.println("<td width=70%>비밀번호<input type=password name=pwd size=15 required>");
		out.println("<input type=hidden name=no value="+no+">");
		// 사용자에게 보여주면 안되는 데이터 => 화면 출력없이 데이터 전송 => hidden
		out.println("</td></tr>");
		out.println("<tr>");
