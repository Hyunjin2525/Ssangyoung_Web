...
<%--
	...
	1. 동작순서
		...
		--------------------------------------------------
			...
			_japDestory() => 새로고침 , 화면이동 ... 메모리에서 해제
	...
	2. 지시자
		...
		--- 
			...
			속성 : 	
				...
				buffer+'8kb => 16kb 23kb
	3. 스크립트 사용법
		자바가 코딩되는 영역
		<%! %> : 선언문 (메소드, 멤버변수) => 사용빈도가 거의 없다
		<%  %> : 자바코딩(일반 자바) => 제어문, 메소드 호출 , 지역변수..
		<%= %> : 화면 출력
		...
		<tr>
			...
			<%--
			 ...
			 --%>
				...
				<input type=text name=tel2 size=15 class="input-sm"> <b>-</b>
				<input type=text name=tel3 size=15 class="input-sm">
			</td>
		</tr>
		<tr>
