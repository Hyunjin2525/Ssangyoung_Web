...
public class StudentList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<tr>");
		out.println("<td>");
		out.println("<a href=StudentInsert class=\"btn btn-sm btn-success\">등록</a>&nbsp");
		out.println("</td>");
		out.println("</tr>");
		out.println("</table>");
		...
		for(StudentVO vo:list)
		{
			...
			out.println("<a href=StudentDelete?hakbun="+vo.getHakbun()+" class=\"btn btn-sm btn-pinfo\">삭제</a>&nbsp");
			out.println("</>");
			out.println("</td>");
			out.println("</tr>");
		}
