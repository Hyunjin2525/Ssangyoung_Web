...
IMP.init("imp63358354"); // 예: imp00000000
function requestPay() {
	console.log('clicked');
...
<h2 class=sectiontitle>${sessionScope.name }님의 장바구니 목록</h2>
		...
		<c:forEach var="vo" items="${list }">
			...
			<td class="text-center">
				<input type=button class="btn btn-sm btn-danger" id="byBtn" value="구매" data-no="${vo.cart_no }">
				<a href="../mypage/cart_cancel.do?no=${vo.cart_no}" class="btn btn-sm btn-success checks">취소</a>
			</td>
			</tr>
		</c:forEach>
		</table>
