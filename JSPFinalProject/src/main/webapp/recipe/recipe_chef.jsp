  		...
  		<table class="table">
  			<tr>
  				<td class="text-center">
  					<a href="../recipe/recipe_chef.do?page=${curpage>1?curpage-1:curpage }" class="btn btn-sm btn-success">이전</a>
  					${curpage } page / ${totalpage } pages
  					<a href="../recipe/recipe_chef.do?page=${curpage<totalpage?curpage+1:curpage }" class="btn btn-sm btn-success">다음</a>
   				</td>
  			</tr>
  		</table>
  	</div>
