		...
		<div class="row">
			...
			<table class="table">
				<tr>
					<td width=30%>ID</td>
					<td width=80%>
						<input type=text name=id size=15 class="input-sm" id=id placeholder="아이디" required>
					</td>
				</tr>
				<tr>
					<td width=20%>Password</td>
					<td width=80%>
						<input type=password name=pwd  size=15 class="input-sm" id=pwd placeholder="비밀번호" required>
					</td>
				</tr>
				<tr>
