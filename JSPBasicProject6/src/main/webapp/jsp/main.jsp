...
<%--
	...
	----------------------------
	Session/Cookie의 차이점 (GET/POST) => MVC구조
	----------------------------
	Session         Cookie
  클래스명 (내장객체)     (필요시마다 생성)
  		HttpSession       Cookie
...
<%
	...
	if(cookies!=null)
	{
		for(int i=cookies.length-1;i>=0;i--)//최신 부터 읽기 시작
		{
...
<body>
	<div class="container">
		...
		<a href="all_cookie.jsp" class="btn btn-xs btn-success">더보기</a>
		<hr>
		<div class="row">
		<%-- 최신 방문 --%>
