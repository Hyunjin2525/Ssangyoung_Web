...
<h1>HttpServletRequest(session):177page</h1>
	<table class="table">
		<tr>
			...
			<td width=80%>HttpSession(request로 생성이 가능:request.getSessio())</td>
			<br>
		...
		<tr>
			...
			<td width=80%>
				<ul>
					...
					<li>저장 기간 설정:setMaxinactiveInterval(int time):/1000=>default</li>
					<li>저장되는 기간: 30분</li>
